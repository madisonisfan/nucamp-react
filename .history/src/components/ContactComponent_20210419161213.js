            ...
            <LocalForm onSubmit={(values) => this.handleSubmit(values)}>
              ...
              <Row className="form-group">
                ...
                <Col md={10}>
                  ...
                  />
                   <Errors className='text-danger' model='.phoneNuum' show='touched' component='div' messages={{
                    required: 'Required', 
              ...
              <Row className="form-group">
                ...
                <Col md={10}>
                  ...
                  />
                   <Errors className='text-danger' model='.emaik' show='touched' component='div' messages={{
                    required: 'Required', 
